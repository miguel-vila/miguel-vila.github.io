...
var _hrldcpr$elm_cons$Cons$toList = function (_p6) {
	var _p7 = _p6;
	return A2(_elm_lang$core$List_ops['::'], _p7._0, _p7._1);
};
var _hrldcpr$elm_cons$Cons$toList$ = function (_p8) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _hrldcpr$elm_cons$Cons$uncons$ = function (_p26) {
	var _p27 = _p26;
	return {
		ctor: '_Tuple2',
		_0: _p27._0,
...
var _hrldcpr$elm_cons$Cons$foldr1 = F2(
	function (f, c) {
		var _p28 = _hrldcpr$elm_cons$Cons$uncons$(c);
...
var _hrldcpr$elm_cons$Cons$tail$ = function (_p29) {
...
var _hrldcpr$elm_cons$Cons$cons$ = F2(
	function (head, tail) {
		return A2(
			_hrldcpr$elm_cons$Cons$cons,
			head,
			_hrldcpr$elm_cons$Cons$toList$(tail));
	});
		...
		if (_p35._1.ctor === '[]') {
			...
			return A2(
				...
				A2(
					_elm_lang$core$List_ops['::'],
					x,
					A2(_elm_lang$core$List$intersperse, x, _p35._1)));
		}
	});
...
var _miguel_vila$conway$Model$getCellAt = F2(
	function (grid, _p0) {
		var _p1 = _p0;
		var row = A2(_elm_lang$core$Array$get, _p1._0, grid);
		return A2(
			_elm_lang$core$Maybe$andThen,
			row,
			_elm_lang$core$Array$get(_p1._1));
	});
var _miguel_vila$conway$Model$n = 25;
var _miguel_vila$conway$Model$neighbours = function (_p2) {
	var _p3 = _p2;
	var _p11 = _p3.y;
	var _p10 = _p3.x;
	var range = _elm_lang$core$Native_List.fromArray(
		[-1, 0, 1]);
	var positions = A2(
		_elm_lang$core$List$concatMap,
		function (i) {
			return A2(
				_elm_lang$core$List$map,
				function (j) {
					return {ctor: '_Tuple2', _0: _p10 + i, _1: _p11 + j};
				},
				range);
		},
		range);
	var isValid = function (_p4) {
		var _p5 = _p4;
		var _p7 = _p5._1;
		var _p6 = _p5._0;
		return (_elm_lang$core$Native_Utils.cmp(0, _p6) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p6, _miguel_vila$conway$Model$n) < 0) && ((_elm_lang$core$Native_Utils.cmp(0, _p7) < 1) && (_elm_lang$core$Native_Utils.cmp(_p7, _miguel_vila$conway$Model$n) < 0)));
	};
	return A2(
		_elm_lang$core$List$filter,
		function (_p8) {
			var _p9 = _p8;
			return (!_elm_lang$core$Native_Utils.eq(_p10, _p9._0)) || (!_elm_lang$core$Native_Utils.eq(_p11, _p9._1));
		},
		A2(_elm_lang$core$List$filter, isValid, positions));
};
var _miguel_vila$conway$Model$getNeighbours = F2(
	function (cell, grid) {
		return A2(
			_elm_lang$core$List$filterMap,
			_miguel_vila$conway$Model$getCellAt(grid),
			_miguel_vila$conway$Model$neighbours(cell));
	});
var _miguel_vila$conway$Model$Cell = F3(
	function (a, b, c) {
		return {active: a, x: b, y: c};
	});
var _miguel_vila$conway$Model$Model = F2(
	function (a, b) {
		return {grid: a, runningPeriodical: b};
	});

var _miguel_vila$conway$Region$markCellAsVisited = F2(
	function (_p0, visited) {
		var _p1 = _p0;
		var _p2 = _p1.x;
		return A2(
			_elm_lang$core$Maybe$withDefault,
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (newRow) {
					return A3(_elm_lang$core$Array$set, _p2, newRow, visited);
				},
				A2(
					_elm_lang$core$Maybe$map,
					function (row) {
						return A3(_elm_lang$core$Array$set, _p1.y, true, row);
					},
					A2(_elm_lang$core$Array$get, _p2, visited))));
	});
var _miguel_vila$conway$Region$markAsVisited = F2(
	function (visited, grid) {
		return A3(_elm_lang$core$List$foldl, _miguel_vila$conway$Region$markCellAsVisited, visited, grid);
	});
var _miguel_vila$conway$Region$visitedPreviously = F2(
	function (visited, _p3) {
		var _p4 = _p3;
		return A2(
			_elm_lang$core$Maybe$withDefault,
			false,
			A2(
				_elm_lang$core$Maybe$andThen,
				A2(_elm_lang$core$Array$get, _p4.x, visited),
				_elm_lang$core$Array$get(_p4.y)));
	});
var _miguel_vila$conway$Region$compareCell = F2(
	function (cell1, cell2) {
		return (_elm_lang$core$Native_Utils.cmp(cell1.x, cell2.x) < 0) ? _elm_lang$core$Basics$LT : (_elm_lang$core$Native_Utils.eq(cell1.x, cell2.x) ? ((_elm_lang$core$Native_Utils.cmp(cell1.y, cell2.y) < 0) ? _elm_lang$core$Basics$LT : (_elm_lang$core$Native_Utils.eq(cell1.y, cell2.y) ? _elm_lang$core$Basics$EQ : _elm_lang$core$Basics$GT)) : _elm_lang$core$Basics$GT);
	});
var _miguel_vila$conway$Region$getCellRegion = F3(
	function (initialVisited, grid, initialCell) {
		var nonVisitedNeighbours = F2(
			function (visited, cell) {
				return A2(
					...
					A2(
						...
						function (c) {
							return _elm_lang$core$Basics$not(
								A2(_miguel_vila$conway$Region$visitedPreviously, visited, c));
						},
						A2(_miguel_vila$conway$Model$getNeighbours, cell, grid)));
			});
		var loop = F3(
			function (queue, visited, acc) {
				...
				while (true) {
					var _p5 = queue;
					if (_p5.ctor === '[]') {
						return {ctor: '_Tuple2', _0: visited, _1: acc};
					} else {
						var _p6 = _p5._0;
						var neighbours = A2(nonVisitedNeighbours, visited, _p6);
						var newVisited = A2(_miguel_vila$conway$Region$markAsVisited, visited, neighbours);
						var newQueue = A2(_elm_lang$core$Basics_ops['++'], neighbours, _p5._1);
						var _v3 = newQueue,
							_v4 = newVisited,
							_v5 = A2(_elm_lang$core$List_ops['::'], _p6, acc);
						queue = _v3;
						visited = _v4;
						acc = _v5;
						continue loop;
		...
		var initialVisited$ = A2(_miguel_vila$conway$Region$markCellAsVisited, initialCell, initialVisited);
		return A3(
			loop,
			_elm_lang$core$Native_List.fromArray(
				[initialCell]),
...
var _miguel_vila$conway$Region$getRegions = function (grid) {
	var rowRegions = F2(
		function (row, _p7) {
			var _p8 = _p7;
			return A3(
				...
				F2(
					function (cell, _p9) {
						...
						var _p13 = _p10._0;
						var _p12 = _p10._1;
						if (cell.active && _elm_lang$core$Basics$not(
							A2(_miguel_vila$conway$Region$visitedPreviously, _p13, cell))) {
							var _p11 = A3(_miguel_vila$conway$Region$getCellRegion, _p13, grid, cell);
							var visited$ = _p11._0;
							var region = _p11._1;
							var regionAsNonempty = _hrldcpr$elm_cons$Cons$fromList(
								A2(_elm_lang$core$List$sortWith, _miguel_vila$conway$Region$compareCell, region));
							var newRegions = A2(
								_elm_lang$core$Maybe$withDefault,
								_p12,
								A2(
									_elm_lang$core$Maybe$map,
									function (region) {
										return A2(_elm_lang$core$List_ops['::'], region, _p12);
									},
									regionAsNonempty));
							return {ctor: '_Tuple2', _0: visited$, _1: newRegions};
						} else {
	...
	var initialVisited = A2(
		_elm_lang$core$Array$repeat,
		_miguel_vila$conway$Model$n,
		A2(_elm_lang$core$Array$repeat, _miguel_vila$conway$Model$n, false));
	var _p14 = A3(
		_elm_lang$core$Array$foldl,
		rowRegions,
		{
...
var _miguel_vila$conway$CellPatterns$colorPalette = A2(
	_elm_lang$core$List$map,
	_rtfeldman$elm_css$Css$hex,
	_elm_lang$core$Native_List.fromArray(
		['e3342e', '55b522', 'ac2ab2', '1f7d00', 'ff83f0', 'd3ca31', '02a8d0', 'a61012', '6a9062', '9d203c', '5a6500', 'ff8eb1', '84400a', 'f1bd74', '8c4954']));
var _miguel_vila$conway$CellPatterns_ops = _miguel_vila$conway$CellPatterns_ops || {};
_miguel_vila$conway$CellPatterns_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _miguel_vila$conway$CellPatterns$matchesPattern = F2(
	function (pattern, region) {
		var miny = _hrldcpr$elm_cons$Cons$minimum(
			A2(
				_hrldcpr$elm_cons$Cons$map,
				function (_) {
					return _.y;
				},
				region));
		var minx = _hrldcpr$elm_cons$Cons$minimum(
			A2(
				_hrldcpr$elm_cons$Cons$map,
				function (_) {
					return _.x;
		...
		var normalized = A2(
			...
			function (_p0) {
				var _p1 = _p0;
				return {ctor: '_Tuple2', _0: _p1.x - minx, _1: _p1.y - miny};
			},
			region);
		return A2(
			_hrldcpr$elm_cons$Cons$any,
			function (p) {
				return _elm_lang$core$Native_Utils.eq(p, normalized);
			},
			pattern);
	});
var _miguel_vila$conway$CellPatterns$compare = F2(
	function (_p3, _p2) {
		var _p4 = _p3;
		var _p9 = _p4._1;
		var _p8 = _p4._0;
		...
		var _p7 = _p5._1;
		var _p6 = _p5._0;
		return _elm_lang$core$Native_Utils.eq(_p8, _p6) ? (_elm_lang$core$Native_Utils.eq(_p9, _p7) ? _elm_lang$core$Basics$EQ : ((_elm_lang$core$Native_Utils.cmp(_p9, _p7) < 0) ? _elm_lang$core$Basics$LT : _elm_lang$core$Basics$GT)) : ((_elm_lang$core$Native_Utils.cmp(_p8, _p6) < 0) ? _elm_lang$core$Basics$LT : _elm_lang$core$Basics$GT);
	});
var _miguel_vila$conway$CellPatterns$rotateClockwise = function (pattern) {
	var maxX = _hrldcpr$elm_cons$Cons$maximum(
		A2(_hrldcpr$elm_cons$Cons$map, _elm_lang$core$Basics$fst, pattern));
	return A2(
		_hrldcpr$elm_cons$Cons$sortWith,
		_miguel_vila$conway$CellPatterns$compare,
		A2(
			_hrldcpr$elm_cons$Cons$map,
			function (_p10) {
				var _p11 = _p10;
				return {ctor: '_Tuple2', _0: _p11._1, _1: maxX - _p11._0};
			},
			pattern));
};
var _miguel_vila$conway$CellPatterns$starExplosion = function () {
	var stage3 = A2(
		_hrldcpr$elm_cons$Cons$cons,
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				{ctor: '_Tuple2', _0: 5, _1: 1},
				{ctor: '_Tuple2', _0: 5, _1: 5},
				{ctor: '_Tuple2', _0: 6, _1: 2},
				{ctor: '_Tuple2', _0: 6, _1: 3},
...
var _miguel_vila$conway$CellPatterns$cross = _hrldcpr$elm_cons$Cons$singleton(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
...
var _miguel_vila$conway$CellPatterns$singleDot = _hrldcpr$elm_cons$Cons$singleton(
	_hrldcpr$elm_cons$Cons$singleton(
		{ctor: '_Tuple2', _0: 0, _1: 0}));
var _miguel_vila$conway$CellPatterns$square = _hrldcpr$elm_cons$Cons$singleton(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 0},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$allRotations = function (base) {
	var rotations = A2(
		_hrldcpr$elm_cons$Cons$cons,
		_miguel_vila$conway$CellPatterns$rotateClockwise,
		A2(_elm_lang$core$List$repeat, 2, _miguel_vila$conway$CellPatterns$rotateClockwise));
	return A3(
		_hrldcpr$elm_cons$Cons$foldl,
		F2(
			function (rotate, templates) {
				var newTemplate = rotate(
					_hrldcpr$elm_cons$Cons$head(templates));
				return A2(
					_hrldcpr$elm_cons$Cons$cons,
					newTemplate,
					_hrldcpr$elm_cons$Cons$toList(templates));
			}),
		_hrldcpr$elm_cons$Cons$singleton(base),
		rotations);
};
var _miguel_vila$conway$CellPatterns$boat = _miguel_vila$conway$CellPatterns$allRotations(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 0},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$loaf = _miguel_vila$conway$CellPatterns$allRotations(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 1},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$corner = _miguel_vila$conway$CellPatterns$allRotations(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 0},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$glider = function () {
	var g4 = A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 2},
		_elm_lang$core$Native_List.fromArray(
	...
	var gs = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[g2, g3, g4]));
	return A2(_hrldcpr$elm_cons$Cons$concatMap, _miguel_vila$conway$CellPatterns$allRotations, gs);
}();
var _miguel_vila$conway$CellPatterns$rotatedClockwiseOnce = function (base) {
	return A2(
		_hrldcpr$elm_cons$Cons$cons,
		base,
		_elm_lang$core$Native_List.fromArray(
			[
				_miguel_vila$conway$CellPatterns$rotateClockwise(base)
			]));
};
var _miguel_vila$conway$CellPatterns$pair = _miguel_vila$conway$CellPatterns$rotatedClockwiseOnce(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 0},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$line = _miguel_vila$conway$CellPatterns$rotatedClockwiseOnce(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 0},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$beehive = _miguel_vila$conway$CellPatterns$rotatedClockwiseOnce(
	A2(
		_hrldcpr$elm_cons$Cons$cons,
		{ctor: '_Tuple2', _0: 0, _1: 1},
		_elm_lang$core$Native_List.fromArray(
...
var _miguel_vila$conway$CellPatterns$toad = function () {
	var period2 = _miguel_vila$conway$CellPatterns$allRotations(
		A2(
			_hrldcpr$elm_cons$Cons$cons,
			{ctor: '_Tuple2', _0: 0, _1: 0},
			_elm_lang$core$Native_List.fromArray(
	...
	var period1 = _miguel_vila$conway$CellPatterns$rotatedClockwiseOnce(
		A2(
			_hrldcpr$elm_cons$Cons$cons,
			{ctor: '_Tuple2', _0: 0, _1: 1},
			_elm_lang$core$Native_List.fromArray(
	...
	return A2(_hrldcpr$elm_cons$Cons$append, period1, period2);
}();
var _miguel_vila$conway$CellPatterns$patternsAndColors = A2(
	_elm_community$list_extra$List_Extra$zip,
	_elm_lang$core$Native_List.fromArray(
		[_miguel_vila$conway$CellPatterns$beehive, _miguel_vila$conway$CellPatterns$square, _miguel_vila$conway$CellPatterns$singleDot, _miguel_vila$conway$CellPatterns$pair, _miguel_vila$conway$CellPatterns$line, _miguel_vila$conway$CellPatterns$boat, _miguel_vila$conway$CellPatterns$loaf, _miguel_vila$conway$CellPatterns$cross, _miguel_vila$conway$CellPatterns$corner, _miguel_vila$conway$CellPatterns$toad, _miguel_vila$conway$CellPatterns$glider, _miguel_vila$conway$CellPatterns$starExplosion]),
	_miguel_vila$conway$CellPatterns$colorPalette);
var _miguel_vila$conway$CellPatterns$getRegionColor = function (region) {
	return A2(
		_elm_lang$core$Maybe$map,
		function (_p12) {
			var _p13 = _p12;
		...
		A2(
			...
			function (_p14) {
				var _p15 = _p14;
				return A2(_miguel_vila$conway$CellPatterns$matchesPattern, _p15._0, region);
			},
			_miguel_vila$conway$CellPatterns$patternsAndColors));
};
var _miguel_vila$conway$CellPatterns$getRegionsColors = _elm_lang$core$List$filterMap(
	function (region) {
		return A2(
			_elm_lang$core$Maybe$map,
			function (color) {
				return A2(_miguel_vila$conway$CellPatterns_ops['=>'], region, color);
			},
			_miguel_vila$conway$CellPatterns$getRegionColor(region));
	});

var _miguel_vila$conway$RandomConway$randomCell = F2(
	function (x, y) {
		return A2(
			_elm_lang$core$Random$map,
			function (active) {
				return A3(_miguel_vila$conway$Model$Cell, active, x, y);
			},
			_elm_lang$core$Random$bool);
	});
var _miguel_vila$conway$RandomConway$randomRow = F2(
	function (n, x) {
		return A2(
			_elm_lang$core$Random$map,
			_elm_lang$core$Array$fromList,
			_elm_community$random_extra$Random_Extra$together(
				A2(
					_elm_lang$core$List$indexedMap,
					F2(
						function (x, y) {
					...
					A2(
						...
						n,
						_miguel_vila$conway$RandomConway$randomCell(x)))));
	});
var _miguel_vila$conway$RandomConway$randomGrid = function (n) {
	return A2(
		_elm_lang$core$Random$map,
		_elm_lang$core$Array$fromList,
		_elm_community$random_extra$Random_Extra$together(
			A2(
				...
				A2(
					_elm_lang$core$List$repeat,
					n,
					_miguel_vila$conway$RandomConway$randomRow(n)))));
};

var _miguel_vila$conway$Update$updateCell = F2(
	function (grid, cell) {
		var neighbours = A2(_miguel_vila$conway$Model$getNeighbours, cell, grid);
		var liveNeighbours = _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				function (_) {
					return _.active;
				...
				neighbours));
		var newState = cell.active ? (_elm_lang$core$Native_Utils.eq(liveNeighbours, 2) || _elm_lang$core$Native_Utils.eq(liveNeighbours, 3)) : _elm_lang$core$Native_Utils.eq(liveNeighbours, 3);
		return _elm_lang$core$Native_Utils.update(
			cell,
			{active: newState});
	});
var _miguel_vila$conway$Update$step = function (grid) {
	return A2(
		_elm_lang$core$Array$map,
		_elm_lang$core$Array$map(
			_miguel_vila$conway$Update$updateCell(grid)),
		grid);
};
var _miguel_vila$conway$Update$executeStep = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			grid: _miguel_vila$conway$Update$step(model.grid)
		});
};
var _miguel_vila$conway$Update$initialGrid = A2(
	_elm_lang$core$Array$initialize,
	_miguel_vila$conway$Model$n,
	function (i) {
		return A2(
			...
			_miguel_vila$conway$Model$n,
			function (j) {
				return A3(_miguel_vila$conway$Model$Cell, false, i, j);
			});
	});
var _miguel_vila$conway$Update$initialModel = {grid: _miguel_vila$conway$Update$initialGrid, runningPeriodical: false};
var _miguel_vila$conway$Update$Clear = {ctor: 'Clear'};
var _miguel_vila$conway$Update$SetRandomGrid = function (a) {
	return {ctor: 'SetRandomGrid', _0: a};
};
var _miguel_vila$conway$Update$generateRandomGrid = A2(
	_elm_lang$core$Random$generate,
	_miguel_vila$conway$Update$SetRandomGrid,
	_miguel_vila$conway$RandomConway$randomGrid(_miguel_vila$conway$Model$n));
var _miguel_vila$conway$Update$init = {ctor: '_Tuple2', _0: _miguel_vila$conway$Update$initialModel, _1: _miguel_vila$conway$Update$generateRandomGrid};
var _miguel_vila$conway$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Switch':
				var _p2 = _p0._0.y;
				var _p1 = _p0._0.x;
				var rowM = A2(_elm_lang$core$Array$get, _p1, model.grid);
				var updatedRowM = A2(
					_elm_lang$core$Maybe$map,
					A2(
						...
						_p2,
						A3(
							_miguel_vila$conway$Model$Cell,
							_elm_lang$core$Basics$not(_p0._0.active),
							_p1,
							_p2)),
					rowM);
				var newGridM = A2(
					_elm_lang$core$Maybe$map,
					function (newRow) {
						return A3(_elm_lang$core$Array$set, _p1, newRow, model.grid);
					},
					updatedRowM);
				var newGrid = A2(_elm_lang$core$Maybe$withDefault, model.grid, newGridM);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'Step':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_miguel_vila$conway$Update$executeStep(model),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'StepPeriodical':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model.runningPeriodical ? _miguel_vila$conway$Update$executeStep(model) : model,
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Run':
				return A2(
			...
			case 'Stop':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'GenerateRandomGrid':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
						[_miguel_vila$conway$Update$generateRandomGrid]));
			case 'SetRandomGrid':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_miguel_vila$conway$Update$initialModel,
					_elm_lang$core$Native_List.fromArray(
						[]));
		}
	});
var _miguel_vila$conway$Update$GenerateRandomGrid = {ctor: 'GenerateRandomGrid'};
var _miguel_vila$conway$Update$Stop = {ctor: 'Stop'};
var _miguel_vila$conway$Update$Run = {ctor: 'Run'};
var _miguel_vila$conway$Update$StepPeriodical = {ctor: 'StepPeriodical'};
var _miguel_vila$conway$Update$Step = {ctor: 'Step'};
var _miguel_vila$conway$Update$Switch = function (a) {
	return {ctor: 'Switch', _0: a};
};

var _miguel_vila$conway$Styles$buttonStyle = _elm_lang$core$Native_List.fromArray(
	[
		_rtfeldman$elm_css$Css$margin(
		_rtfeldman$elm_css$Css$px(5))
	]);
var _miguel_vila$conway$Styles$inactiveColor = _rtfeldman$elm_css$Css$hex('CCCCCC');
var _miguel_vila$conway$Styles$activeColor = _rtfeldman$elm_css$Css$hex('7A7A7A');
var _miguel_vila$conway$Styles$cellSize = 20;
var _miguel_vila$conway$Styles$cellStyle = function (color) {
	return _elm_lang$core$Native_List.fromArray(
		[
			_rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$relative),
			_rtfeldman$elm_css$Css$backgroundColor(color),
			_rtfeldman$elm_css$Css$float(_rtfeldman$elm_css$Css$left),
			_rtfeldman$elm_css$Css$width(
			_rtfeldman$elm_css$Css$px(_miguel_vila$conway$Styles$cellSize)),
			_rtfeldman$elm_css$Css$height(
			_rtfeldman$elm_css$Css$px(_miguel_vila$conway$Styles$cellSize)),
			_rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$pointer)
		]);
};
var _miguel_vila$conway$Styles$activeStyles = _miguel_vila$conway$Styles$cellStyle(_miguel_vila$conway$Styles$activeColor);
var _miguel_vila$conway$Styles$inactiveStyles = _miguel_vila$conway$Styles$cellStyle(_miguel_vila$conway$Styles$inactiveColor);

var _miguel_vila$conway$View$getColor = function (regionsColors) {
	var defaultColor = function (cell) {
		return cell.active ? _miguel_vila$conway$Styles$activeColor : _miguel_vila$conway$Styles$inactiveColor;
	};
	var colorByRegion = function (cell) {
		return A2(
			_elm_lang$core$Maybe$map,
			function (_p0) {
				var _p1 = _p0;
			...
			A2(
				...
				function (_p2) {
					...
					return A2(
						_hrldcpr$elm_cons$Cons$any,
						function (regCell) {
							return _elm_lang$core$Native_Utils.eq(regCell, cell);
						},
						_p3._0);
				},
				regionsColors));
...
var _miguel_vila$conway$View$styles = function (_p4) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p4));
};
var _miguel_vila$conway$View$conwayButton = F3(
	function (isEnabled, msg, textString) {
		return A2(
			_elm_lang$html$Html$button,
			_elm_lang$core$Native_List.fromArray(
				[
					_miguel_vila$conway$View$styles(_miguel_vila$conway$Styles$buttonStyle),
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(textString)
				]));
	});
var _miguel_vila$conway$View$enabledButton = _miguel_vila$conway$View$conwayButton(true);
var _miguel_vila$conway$View$playPauseButt = function (running) {
	return running ? A2(_miguel_vila$conway$View$enabledButton, _miguel_vila$conway$Update$Stop, '⏸') : A2(_miguel_vila$conway$View$enabledButton, _miguel_vila$conway$Update$Run, '▶️');
};
var _miguel_vila$conway$View$buttons = function (running) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A3(
				_miguel_vila$conway$View$conwayButton,
				_elm_lang$core$Basics$not(running),
				_miguel_vila$conway$Update$Step,
				'One step'),
				_miguel_vila$conway$View$playPauseButt(running),
				A2(_miguel_vila$conway$View$enabledButton, _miguel_vila$conway$Update$GenerateRandomGrid, 'Generate Random'),
				A2(_miguel_vila$conway$View$enabledButton, _miguel_vila$conway$Update$Clear, 'Clear')
			]));
};
var _miguel_vila$conway$View$centerGridStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin', _1: '0 auto'}
		]));
var _miguel_vila$conway$View$cellView = F2(
	function (color, cell) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_miguel_vila$conway$View$styles(
					_miguel_vila$conway$Styles$cellStyle(color)),
					_elm_lang$html$Html_Events$onClick(
					_miguel_vila$conway$Update$Switch(cell))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _miguel_vila$conway$View$gridView = function (grid) {
	var regions = _miguel_vila$conway$Region$getRegions(grid);
	var regionsColors = _miguel_vila$conway$CellPatterns$getRegionsColors(regions);
	var getCellColor = _miguel_vila$conway$View$getColor(regionsColors);
	var tableCell = function (cell) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_miguel_vila$conway$View$cellView,
					getCellColor(cell),
					cell)
				]));
	};
	var rowView = function (row) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[]),
			A2(_elm_lang$core$List$map, tableCell, row));
	};
	var tableRows = A2(
		_elm_lang$core$List$map,
		function (_p5) {
			return rowView(
				_elm_lang$core$Array$toList(_p5));
		},
		_elm_lang$core$Array$toList(grid));
	return A2(
		_elm_lang$html$Html$table,
		_elm_lang$core$Native_List.fromArray(
			[_miguel_vila$conway$View$centerGridStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _miguel_vila$conway$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_miguel_vila$conway$View$buttons(model.runningPeriodical),
				_miguel_vila$conway$View$gridView(model.grid)
			]));
};

var _miguel_vila$conway$Conway$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Time$every,
		_elm_lang$core$Time$second / 3,
		_elm_lang$core$Basics$always(_miguel_vila$conway$Update$StepPeriodical));
};
var _miguel_vila$conway$Conway$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _miguel_vila$conway$Update$init, update: _miguel_vila$conway$Update$update, view: _miguel_vila$conway$View$view, subscriptions: _miguel_vila$conway$Conway$subscriptions})
};

var Elm = {};
Elm['Conway'] = Elm['Conway'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Conway'], 'Conway', typeof _miguel_vila$conway$Conway$main === 'undefined' ? null : _miguel_vila$conway$Conway$main);
